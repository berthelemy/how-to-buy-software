...
(function() {
    ...
    function createConsentBanner(onAllow, onDeny) {
        ...
        text.textContent = 'I store a single cookie in your browser so that I can count the number of times you visit this site. I do not know who you are, and do not use the cookie for any other purpose, nor is it sold or given to anyone else.';
